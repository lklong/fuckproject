	...
	<div class="admincenter">
		<div class="admincenterleft">
			...
			<ul class="tjulbj" id="sujuid">
				<li onclick="" class="secltedtj"><img src="img/admin/heisgx.jpg" width="4" height="7" /><span class="ml10">商品审核</span></li>
				<li ><a href="admin/auth/company/waitApprove"><img src="img/admin/heisgx.jpg" width="4" height="7" /><span class="ml10">企业认证审核</span></a></li>
