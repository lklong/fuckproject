	...
	<div class="body_center2 fl p10 ml10"  id="alldd">
		...
		<div class="jibenxinxi ml20">
		   ...
		   <div class="jibenform">
			   ...
			   <span class="jian fl"><input type="text" id="goodsPrice" class="biaobeititle fl" style="width: 100px" onkeyup='zhigu.goods.priceInputCheck(this);' onafterpaste='zhigu.goods.priceInputCheck(this);' /></span>
			   <div class="clear"></div>
		   </div>
...
function loadFolderFile() {
	if (zTree.getSelectedNodes()[0]) {
		ajaxSubmit("/supplier/space/folderFileMini", {"folderID" : zTree.getSelectedNodes()[0].id}, function(data) {
