              ...
              <div class="zhifubaoform">
                ...
                <div class="zfbBox">
                  <form action="/user/recharge/pay" id="rechargeForm" method="post"  target="_blank">
                    <h2 class="ml50" > 您正在为智谷同城货源网账户<font color="#ff3300"><strong> ${auth.username } </strong></font>充值 </h2>
                    <div class="formdiv2 mt5 ml50"> 支付金额：
                      <input type="text" id="money" class="input-txt" name="money" onkeyup="zhigu.cmn.restrictInputMoney(this);" />
                    </div>
                    <div class="ml50"> <span class="color-red" id="e_msg"></span> </div>
                    <div> 充值类型：
                      <input type="radio" name="rechargeType" value="1" checked="checked" />
                      <img class="ml20" src="img/zhifubao.jpg" /> </div>
                    <div class="ml50">
            ...
            <c:otherwise>
              <div class="chongzhi1">
                ...
                <div class="chongzhibot">
                  <p class="czbot1"> - 您尚未设置支付密码，请先设置：<a href="user/security/paymentpwd" class="default-a">支付密码 >></a> </p>
