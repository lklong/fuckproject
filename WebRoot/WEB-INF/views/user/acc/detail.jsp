        ...
        <div class="mingxi">
          ...
          <div class="fun-bar">
            <form class="" method="post" id="accDetailForm" action="user/acc/detail">
              ...
              <span class="fl ml20">从</span>
              <input type="text" class="jcDate input-txt jcDateIco fl ml20" name="startDateStr"  value="<fmt:formatDate value='${startDate }' pattern='yyyy-M-d'/>"/>
              <span class="fl ml20">到</span>
              <input type="text" class="jcDate input-txt jcDateIco fl ml20"  name="endDateStr" value="<fmt:formatDate value='${endDate }' pattern='yyyy-M-d'/>"/>
          ...
          <table cellpadding="0" cellspacing="0" class="user-list-table txt-center">
            ...
            <c:forEach var="detail" items="${list}">
              <tr>
                ...
                <td><c:if test="${detail.incomeFlag}"> +${detail.dealMoney} </c:if></td>
                <td><span class="color-red">
                  <c:if test="${!detail.incomeFlag}"> -${detail.dealMoney} </c:if>
                  </span></td>
              </tr>
            </c:forEach>
          </table>
