					...
					<div class="shimingform mt20">
						<form method="post" action="#">
							...
							<div class="shimingbox">
								...
								<input class="smtext fl" type="text" placeholder="请输入真实姓名" /> <span
									class="shiminghelp fl">真实姓名只能含汉字、字母、符号中的空格与点，且长度在2～30个汉字之间</span>
								<div class="clear"></div>
							</div>
							<div class="shimingbox">
								<p class="smtitle">
							...
							<div class="shimingbox">
								...
								<input class="smtext fl" type="text" placeholder="请选择日期"
									onfocus="HS_setDate(this)" /> <span class="shiminghelp fl">请输入正确的身份证号码</span>
							...
							<div class="shimingbox" id="shimingbox1">
								...
								<div class="sfzbox fl">
									<span class="sfzscbg"></span>
									<!--图片正在上传背景-->
									<p class="shangchuanbg"></p>
									<!--图片正在上传文字-->
