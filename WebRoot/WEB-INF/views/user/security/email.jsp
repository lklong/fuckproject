	...
	<div class="rightContainer fr">
		...
		<form method="post" action="#">
			<table cellpadding="0" cellspacing="0" class="user-form-table">
				...
				<tr>
					<td>新邮箱：</td>
					<td><input class="input-txt" name="email" id="email"
						type="text" /> <span class="color-red" id="mailhelp"></span></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td><input type="button" class="input-button" width="100"
						onclick="_submit(this)" value="发送验证链接" /></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
