...
<div class="rightContainer fr">
  <h4 class="ddtitle">基本信息</h4>
  <!--// 内容框 //-->
  <div class="rc_body">
    <div id="userContents" class="userContents">
      <div class="user-photo fl">
        <div> <img src="${info.avatar}" id="avatarpic"
							style="width: 120px; height: 120px;" /> </div>
        <p> <a href="javascript:void(0)" onclick="avatar()"
							class="edit-user-photo">编辑头像</a> </p>
      </div>
        ...
        <div>
          <form action="user/info/modify" id="infoForm" method="post">
            <table cellpadding="0" cellspacing="0" class="user-form-table">
              ...
              <tr>
                <td>性别：</td>
                <td><input id="nan" checked="checked" type="radio"
										name="gender" value="1" />
                  <label for="nan">男</label>
                  <input
										id="nv"
										<c:if test="${info.gender == 2 }">checked="checked"</c:if>
              ...
              <tr>
                <td>街道：</td>
                <td><input name="street" id="street" maxlength="200"
										value="${info.street }" class="input-txt" /></td>
              </tr>
              <tr>
                <td>邮编：</td>
                <td><input type="text" name="postCode"
										value="${info.postCode }" class="input-txt" /></td>
              </tr>
              <tr>
                <td>固定电话：</td>
                <td><input type="text" id="tel" name="tel"
										value="${info.tel }" placeholder="格式：区号-座机号" class="input-txt" /></td>
              </tr>
              <tr>
                <td>QQ号码：</td>
                <td><input type="text" name="QQ" value="${info.QQ }"
										class="input-txt" /></td>
              </tr>
              <tr>
                <td>阿里旺旺：</td>
                <td><input type="text" name="aliWangWang"
										value="${info.aliWangWang }" class="input-txt" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><input class="input-button" type="button" value="保存"
										id="saveBaseInfo" /></td>
              </tr>
            </table>
          </form>
...
<div id="avatarDiv" style="display: none;">
  <iframe src="/js/3rdparty/avatar/header.jsp" id="headFram"
			style="border: 1px;" scrolling="no" width="650" height="450"></iframe>
</div>
<script type="text/javascript">
		$()
				.ready(
						function() {
							//初始化
							var pca = new PCAS("province", "city", "district",
											...
											function() {
												ajaxSubmit(
														...
														$("#infoForm")
																.serialize(),
														function(data) {
															layer.alert(data.msg,function(){f5()});
														});
											});
						});
		//头像
		var avatarDialogId;
		function avatar() {
			avatarDialogId = layer.open({
			    type: 1,
			    title : "上传头像",
			    skin: 'layui-layer-rim', //加上边框
			    area: [ '650px', '490px' ],
			    content: $("#avatarDiv").html()
			});
		}
		//重置头像
