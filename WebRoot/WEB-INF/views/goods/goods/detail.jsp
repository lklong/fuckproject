  ...
  <div class="goodsBodyInside">
    <div class="detailsLeft">
      <div class="goodsImgTxtBox">
        <div class="gitbLeft">
          <div class="gitbImgBox"> <span> <a href="${goods.images[0].image }" class="MagicZoom image_replace_a" id="MagicZoom" rel="zoom-width:430px; zoom-height:430px"> <img src="${goods.images[0].image}" class="image_replace_img" style="max-height: 430px; max-width: 430px; width: 430px;"  /><!--style="max-height:398px;max-width:398px;"  --> 
            </a> </span> </div>
          <ul class="gitbThumbImgList">
            <c:forEach items="${goods.images }" var="item" end="4">
              <li> <a href="${item.image }" rel="MagicZoom" rev="${item.image300 }"> <img src="${item.image300}_160x160.jpg" width="58" height="58" /> </a> </li>
            </c:forEach>
          </ul>
        </div>
        <div class="gitbRight">
          ...
          <div id="J_isku"  class="tb-key tb-key-sku "> 
            ...
            <div class="tb-skin">
              ...
              <dl class="tb-amount tb-clearfix">
                ...
                <dd> <span class="tb-stock" id="J_Stock"> <a href="javascript:void(0)" hidefocus class="tb-reduce J_Reduce tb-iconfont">－</a>
                  <input id="J_IptAmount" type="text" class="tb-text" value="1"  maxlength="8" title="请输入购买量"/>
                  <a href="javascript:void(0)" hidefocus class="tb-increase J_Increase tb-iconfont">＋</a>件 </span>
                  <lable>
                    <input id="sku_id" name="sku_id" type="hidden"/>
                    (库存<span id="J_SpanStock"  class="tb-count">${goods.aux.amount}</span>件)</lable>
                </dd>
              </dl>
            ...
            <div class="addMarkFav">
              ...
              <table>
                <tr>
                  <td style="padding-right: 0px;width:55px"><div data-bd-bind="1425354311818" id="bdshare" class="bdsharebuttonbox bdshare-button-style0-16" data="{'url':'goods/detail?goodsId=4985'}" data-tag="share_4985" style="float:left;"> <a href="javascript:void(0);" class="bds_more" data-cmd="more" style="margin: 0px;">分享到</a></div></td>
                  <td style="width: 0px; padding-right: 0px;"><img src="img/default/icon_2.gif"></td>
        ...
        <div class="selTab baseInfo">
          ...
          <br style="clear:both" />
          <div class="mt10" id="description"> ${goods.description } </div>
        </div>
        <!--** 下载列表 **-->
...
<div id="url_copy_div"  title="图片外链" modal="true" closed="true" class="easyui-dialog hidden"  style="padding: 20px;width: 770px;height: 550px;">
  <p>以下为商品详情代码</p>
  <br/>
  <input onclick="$('#url_copy').select();" value="点此全选以下内容" type="button">
  <input onclick="copy_clip();" value="点此复制以下内容" type="button">
  <br/>
  <br/>
  <textarea style="height: 400px;width: 700px;" id="url_copy">没有数据！</textarea>
</div>
<form action="user/order/confirm" method="post" id="confirmForm">
</form>
<script type="text/javascript">
