	...
	.reply_text{
		...
		height: 55px;
	                 ...
	                 <c:forEach items="${page.datas}" var="comment">
	                	<div class="pingLunCommandBox type_${comment.type}">
	                		...
	                		<div class="commandRight">
	                			<div>
	                				<h3>
	                				<span><fmt:formatDate value="${comment.addTime }" pattern="yyyy-MM-dd HH:mm:ss"/>发布“评价”</span>
                                ...
                                <c:if test="${comment.merchantReply!=null}">
	                			    <p>回复：${comment.merchantReply}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;回复时间：<fmt:formatDate value="${comment.replyTime}" pattern="yyyy-MM-dd HH:mm:ss"/></p>
                                </c:if>
                ...
                <div class="commandSubmitBox disnone">
                		<div>评分：<img src="img/star2.png" /><img src="img/star2.png" /><img src="img/star2.png" /><img src="img/star2.png" /><img src="img/star2.png" />&nbsp;&nbsp;5星</div>
                		<div>用户名：西西</div>
                		<div>
                			<textarea rows="" cols="" class="submitTextArea"></textarea>
                		</div>
                		<div><button class="tijiaoPingLun">提交评论</button></div>
                </div> 
