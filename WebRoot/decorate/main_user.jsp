...
<link rel="stylesheet" type="text/css" href="/css/wangshang.css" />
<link rel="stylesheet" type="text/css" href="/css/zuce.css" />
<link rel="stylesheet" type="text/css" href="/css/chongzhi.css?v=20150311" />
...
<%-- 				</c:if> --%>
			...
			<c:if test="${sessionScope.sessionUser.userType>1 }">
				...
				<ul class="tit_hover">
					...
					<li><a href="/supplier/store/decorateInit">店铺简介 </a></li>
