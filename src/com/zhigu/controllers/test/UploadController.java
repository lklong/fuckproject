...
//import com.zhigu.service.zhigufile.NZhiguFileService;
...
//
//	@Autowired
//	private NZhiguFileService nZhiguFileService;
//
//	// 缓存文件头信息-文件头信息
...
//			// "goods_d");
//			return zhiguFileService.saveImage(file, specs, ImageSource.Goods_Main.getType(), null, 975, null);
//		} catch (IOException e) {
...
//		try {
//			return nZhiguFileService.saveImage(file, source);
//		} catch (IOException e) {
//			return new MsgBean(Code.FAIL, "图片保存失败，请重试", MsgLevel.ERROR);
//		}
//	}
...
//		try {
//			return zhiguFileService.saveImage(file, specs, ImageSource.Goods_Main.getType(), 430, 430 * 3, "goodsm_");
//		} catch (IOException e) {
//			return new MsgBean(Code.FAIL, "图片保存失败，请重试", MsgLevel.ERROR);
//		}
//	}
...
//		try {
//
//			MsgBean msgBean = nZhiguFileService.saveImage(upfile, ImageSource.Goods_Description.getType());
//			if (msgBean.getCode() == Code.SUCCESS) {
//
//				ueditorImage.setState("SUCCESS");
//				ueditorImage.setUrl(((ZhiguFile) msgBean.getData()).getUri() + "_975x0.jpg");
...
//		try {
//			return zhiguFileService.saveImage(file, null, ImageSource.User_Card.getType(), null, 800, "cd_");
//		} catch (IOException e) {
//			return new MsgBean(Code.FAIL, "图片保存失败，请重试", MsgLevel.ERROR);
//		}
//	}
...
//
//		try {
//			MsgBean msg = zhiguFileService.saveImage(logoFile, null, ImageSource.User_Certificate.getType(), null, 800, null);
